    ...
    <div>
      ...
      <span className="fs-5 fw-bold  ps-3 ">Category:</span>
        <div className='col pt-3'>
            <Link href={'/categories/cat_RyWOwmv26onEa2'} className='category-link ps-2'>
        ...
        <div className='col-12 pt-3'>
            <Link href={'/categories/cat_DWy4oGRaMw6Jx2'} className='category-link ps-2'>
        ...
        <div className='col-12 pt-3'>
            <Link href={'/categories/cat_zkK6oL6GVlXn0Q'} className='category-link ps-2'>
        ...
        <div className='col-12 pt-3'>
            <Link href={'/categories/cat_4WJvlKELMobYV1'} className='category-link ps-2'>
